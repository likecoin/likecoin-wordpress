 ...
 * Description:  FINAL LEGACY VERSION: Read-only maintenance version before 3ook.com transition. Existing widgets remain functional.
 * Version:      4.0.0
 * Author:       LikeCoin
...
define( 'LC_PLUGIN_VERSION', '4.0.0' );
